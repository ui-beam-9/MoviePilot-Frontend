export default {
  ...
  login: {
    ...
    loginWithOIDC: 'OIDC 登錄',
    oidcUnbound: '該 OIDC 賬號未綁定用戶，請先使用用戶名密碼登錄後綁定',
    oidcError: 'OIDC 認證失敗',
    userInactive: '用戶已被禁用',
    loggingIn: '正在登錄',
    pleaseWait: '請稍候...',
  ...
  settingTabs: {
    ...
    oidc: {
      title: 'OIDC 登錄',
      description: 'OIDC 簽發者、客戶端配置、回調地址、連接測試',
    },
    about: {
      title: '關於',
      description: '軟件版本',
  ...
  user: {
    ...
    noEmail: '未設置郵箱',
    oidcBound: '已綁定OIDC',
    oidcBoundWith: '已綁定 {sub}',
    movieSubscriptions: '電影訂閱',
    tvSubscriptions: '劇集訂閱',
    cannotDeleteCurrentUser: '不能刪除當前登入用戶！',
    bindOidc: '綁定OIDC賬號',
    bindOidcSuccess: 'OIDC賬號綁定成功',
    bindOidcFailed: 'OIDC賬號綁定失敗',
    unbindOidc: '解綁OIDC賬號',
    confirmUnbindOidc: '確定要解綁OIDC賬號嗎？解綁後將無法使用OIDC登錄。',
    unbindOidcSuccess: 'OIDC賬號解綁成功',
    unbindOidcFailed: 'OIDC賬號解綁失敗',
  ...
  setting: {
    ...
    oidc: {
      title: 'OIDC 登錄',
      description: '配置 OpenID Connect 登錄，允許通過外部身份提供商進行認證登錄',
      issuer: '簽發者 URL (Issuer)',
      issuerPlaceholder: 'https://your-idp.example.com/realms/master',
      issuerHint: 'OIDC 提供商的簽發者 URL',
      clientId: '客戶端 ID',
      clientIdPlaceholder: 'your-client-id',
      clientSecret: '客戶端密鑰',
      clientSecretPlaceholder: 'your-client-secret',
      scopes: '請求的 Scopes',
      scopesHint: '空格分隔的 OAuth2 scope 列表，通常為 openid profile email',
      redirectUri: '回調地址 (Redirect URI)',
      redirectUriHint: 'OIDC 提供商中配置的回調地址，留空則自動根據當前訪問地址生成',
      redirectUriCopy: '複製回調地址',
      enabledStatus: 'OIDC 登錄已啟用，用戶可使用 OIDC 賬號登錄',
      disabledStatus: 'OIDC 登錄未啟用',
      testConnection: '測試連接',
      testNotSaved: '請先保存設置後再測試',
      testDiscoveryFailed: '發現文檔獲取失敗 (HTTP {status})',
      testInvalidDiscovery: '發現文檔缺少必要字段 (authorization_endpoint 或 token_endpoint)',
      testSuccess: '連接測試成功，發現文檔獲取正常',
      testError: '測試失敗: {error}',
      issuerRequired: '請先填寫簽發者 URL',
      saveSuccess: 'OIDC 設置保存成功',
      saveFailed: 'OIDC 設置保存失敗',
      usageGuide: '使用指南',
      guideStep1: '1. 在您的 OIDC 提供商（如 Keycloak、Authentik、Okta 等）中創建一個 OIDC 客戶端',
      guideStep2: '2. 將客戶端的回調地址設置為以下地址（點擊可複製）：',
      guideStep3: '3. 填寫簽發者 URL、客戶端 ID 和客戶端密鑰',
      guideStep4: '4. 保存設置後，登錄頁面將顯示 OIDC 登錄按鈕',
      guideStep5: '5. 已登錄用戶可在 個人資訊 → 雙重驗證 → OIDC 中綁定/解綁賬號',
      serverConfig: '服務配置',
      accountBinding: '賬號綁定',
    },
    words: {
  ...
  profile: {
    ...
    doubanUser: '豆瓣用戶',
    oidcUser: 'OIDC 賬號',
    oidcUserPlaceholder: '未綁定',
    oidcNotEnabled: '管理員未啟用 OIDC 登錄，請聯繫管理員開啟',
