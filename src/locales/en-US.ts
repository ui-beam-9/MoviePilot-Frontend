export default {
  ...
  login: {
    ...
    oidcAuthCanceled: 'OIDC authentication canceled',
    ...
    loginWithOIDC: 'OIDC Login',
    oidcUnbound: 'This OIDC account is not bound to any user. Please log in with username and password first, then bind your OIDC account',
    oidcError: 'OIDC authentication failed',
  ...
  settingTabs: {
    ...
    oidc: {
      title: 'OIDC Login',
      description: 'OIDC issuer, client configuration, callback URL, connection test',
    },
    about: {
      title: 'About',
  ...
  user: {
    ...
    bindOidc: 'Bind OIDC Account',
    bindOidcSuccess: 'OIDC account bound successfully',
    bindOidcFailed: 'Failed to bind OIDC account',
    unbindOidc: 'Unbind OIDC Account',
    confirmUnbindOidc: 'Are you sure you want to unbind your OIDC account? You will not be able to log in with OIDC after unbinding.',
    unbindOidcSuccess: 'OIDC account unbound successfully',
    unbindOidcFailed: 'Failed to unbind OIDC account',
  ...
  setting: {
    ...
    oidc: {
      title: 'OIDC Login',
      description: 'Configure OpenID Connect login to allow authentication via external identity providers',
      issuer: 'Issuer URL',
      issuerPlaceholder: 'https://your-idp.example.com/realms/master',
      issuerHint: 'OIDC provider issuer URL',
      clientId: 'Client ID',
      clientIdPlaceholder: 'your-client-id',
      clientSecret: 'Client Secret',
      clientSecretPlaceholder: 'your-client-secret',
      scopes: 'Requested Scopes',
      scopesHint: 'Space-separated OAuth2 scope list, typically openid profile email',
      redirectUri: 'Redirect URI',
      redirectUriHint: 'The callback URL configured in your OIDC provider, leave empty to auto-generate from current access URL',
      redirectUriCopy: 'Copy Redirect URI',
      enabledStatus: 'OIDC login is enabled, users can login with OIDC accounts',
      disabledStatus: 'OIDC login is not enabled',
      testConnection: 'Test Connection',
      testNotSaved: 'Please save settings before testing',
      testDiscoveryFailed: 'Failed to fetch discovery document (HTTP {status})',
      testInvalidDiscovery: 'Discovery document missing required fields (authorization_endpoint or token_endpoint)',
      testSuccess: 'Connection test successful, discovery document fetched correctly',
      testError: 'Test failed: {error}',
      issuerRequired: 'Please fill in the Issuer URL first',
      saveSuccess: 'OIDC settings saved successfully',
      saveFailed: 'Failed to save OIDC settings',
      usageGuide: 'Usage Guide',
      guideStep1: '1. Create an OIDC client in your OIDC provider (e.g., Keycloak, Authentik, Okta)',
      guideStep2: '2. Set the client callback URL to the following address (click to copy):',
      guideStep3: '3. Fill in the Issuer URL, Client ID, and Client Secret',
      guideStep4: '4. After saving, the OIDC login button will appear on the login page',
      guideStep5: '5. Logged-in users can bind/unbind OIDC accounts from Profile → Two-Factor Authentication → OIDC',
  ...
  profile: {
    ...
    oidcUser: 'OIDC Account',
    oidcUserPlaceholder: 'Not bound',
    oidcNotEnabled: 'OIDC login is not enabled by the administrator, please contact the administrator',
    ...
    useOidc: 'Sign in with OIDC',
    configOidc: 'Configure OIDC Login',
    enabled: 'Enabled',
